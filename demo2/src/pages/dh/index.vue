<template>
  <div class="bg-color">
    <view class="section">
      <picker class="row-picker" mode="selector" @change="bindEquipmentsChange" value="{{eIndex}}" range="{{equipments}}">
        <div class="flex-h">
          <view class="weui-cells__title section-title">超差装置：</view>
          <view class="weui-cells weui-cells_after-title right-picker">
            <view class="right-center-view">{{ equipments[eIndex]}} </view>
          </view>
        </div>
      </picker>
