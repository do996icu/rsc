    ...
    <div class="bg-color">
        ...
        <div class="condition-01">
            ...
            <div class="h-section">
                ...
                <view class="weui-cells weui-cells_after-title">
                    <view class="weui-cell weui-cell_input">
                        <input class="weui-input  felix-input" @blur="fnBlurDLGHB(event)" @input="fnInputDLGHB(event)" maxlength="2"  type="digit" v-model='dlhgb' placeholder="请输入变比"/>
                    </view>
                </view>
            </div>
        </div>
    ...
    methods: {
        ...
        fnCalcResult(e) {
          ...
          console.table(this.isGx ? '1.0000' : '-1.0000')
            ...
            this.dialog.wz = parseFloat(this.model.dW).toFixed(2);
