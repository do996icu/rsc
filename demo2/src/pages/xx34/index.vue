...
<script>
  ...
  const dyhgbs = ['0.38kV/0.38kV', '10kV/0.1kV', '35kV/0.1kV', '66kV/0.1kV'];
  const objectdyhgbs = [{name:'0.38kV/0.38kV', rate: 1},{name:'10kV/0.1kV',  rate: 100 }, {name:'35kV/0.1kV',rate: 350}, {name:'66kV/0.1kV', rate: 660}];
  const mulitLeftArr = [];
